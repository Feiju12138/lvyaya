package com.yonyou.textsearch.dto;
...
public class SimpleSearchDTO {
    ...
    private static String PARAM_SEARCH_PREFIX = "search_";
        private String search_rubbish_name;     //垃圾名称

        public void setSearch_rubbish_name(String rubbish_name){
            this.search_rubbish_name = rubbish_name;
        }
        public String getSearch_rubbish_name(){
            return this.search_rubbish_name;
        }
